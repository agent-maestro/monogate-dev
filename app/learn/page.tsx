...
export const metadata: Metadata = {
  ...
  description:
    "Two learning tracks: EML-lang (write math, compile to 36 targets, no prerequisites beyond algebra) and Lean (formal verification across 6 lanes, powered by the PETAL dataset).",
};
