import{r as h,j as a}from"./react-BGrcABR8.js";import{O as C,g as M,ak as N}from"./icons-B9WjPO1w.js";import{b as T,H as L,n as I}from"./vendor-D_gfsaub.js";function v(e){return`electronics-lab:${e}:prediction:v1`}function Q({courseId:e,config:t,revealed:n}){const[s,r]=h.useState(""),[l,c]=h.useState(null);h.useEffect(()=>{try{const u=window.localStorage.getItem(v(e));u!==null&&c(Number(u))}catch{}},[e]);function o(){const u=Number(s);if(Number.isFinite(u)){c(u);try{window.localStorage.setItem(v(e),String(u))}catch{}}}const i=l!==null&&Math.abs(l-t.answer)<=t.tolerance;return a.jsxs("section",{className:"predict-beat","aria-label":"Predict before you build",children:[a.jsxs("p",{className:"predict-beat-kicker",children:[a.jsx(C,{"aria-hidden":"true"})," Beat 1 · Predict"]}),a.jsx("h3",{children:t.question}),l===null?a.jsxs(a.Fragment,{children:[a.jsx("p",{className:"predict-beat-hint",children:t.hint}),a.jsxs("div",{className:"predict-beat-input",children:[a.jsx("label",{htmlFor:"predict-input",className:"visually-hidden",children:"Your prediction"}),a.jsx("input",{id:"predict-input",type:"number",step:"0.01",inputMode:"decimal",value:s,placeholder:"your guess",onChange:u=>r(u.target.value),onKeyDown:u=>{u.key==="Enter"&&o()}}),a.jsx("button",{type:"button",onClick:o,disabled:s.trim()==="",children:"Lock it in"})]}),a.jsx("p",{className:"predict-beat-note",children:"Locked before the build starts. Being wrong here is the point — it is what makes the real number mean something."})]}):n?a.jsxs("div",{className:i?"predict-beat-reveal is-called":"predict-beat-reveal",children:[a.jsxs("div",{className:"predict-beat-compare",children:[a.jsxs("span",{children:["you said ",a.jsx("strong",{children:l})]}),a.jsxs("span",{children:["it is ",a.jsx("strong",{children:t.answerLabel})]})]}),a.jsx("p",{children:i?"Called it.":"Not what you expected — and that is the lesson."}),a.jsx("p",{className:"predict-beat-why",children:t.answerNote})]}):a.jsxs("p",{className:"predict-beat-locked",children:[a.jsx(M,{"aria-hidden":"true"})," You predicted ",a.jsx("strong",{children:l}),". Finish the build and the bench will tell you what it actually does."]})]})}function Z({modes:e}){return e.length===0?null:a.jsxs("section",{className:"what-goes-wrong","aria-label":"What goes wrong",children:[a.jsxs("p",{className:"what-goes-wrong-kicker",children:[a.jsx(N,{"aria-hidden":"true"})," Beat 5 · What goes wrong"]}),a.jsx("ul",{children:e.map(t=>a.jsxs("li",{children:[a.jsx("strong",{children:t.failure}),a.jsx("span",{children:t.why})]},t.failure))})]})}const R=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8" />
...
`,y={courseTitle:"ARTY-001 Switch Guard — Virtual Verification Replay",contractRule:"safe_output never exceeds the safe_limit or the requested_output",fields:{demandLabel:"switch_bits",requested:"requested_output",safe:"safe_output",limit:"safe_limit",margin:"safety_margin",violation:"violation_latched",guardAction:"guard_action",clampValue:"clamp_to_safe_output",button:"button_pressed"},contractCeilings:["safe_limit","requested_output"],trackLimitMoves:!0,traces:[{key:"requested_output",label:"request",color:"#f7b267",width:2},{key:"safe_output",label:"safe",color:"#8ee0b2",width:4},{key:"safe_limit",label:"limit",color:"#ffd166",width:1,dashed:!0}],provenance:[{key:"board_id",label:"Board"},{key:"kernel_id",label:"Kernel"},{key:"schema_version",label:"Schema"},{key:"source_mode",label:"Source"}],liveSourceValue:"live_board",buttonOnMessage:"Surge asserted (BTN0) — demand pushed over the limit.",buttonOffMessage:"Surge released (BTN0).",rubric:[{label:"Demand ramped toward full",test:{type:"maxAtLeast",field:"requested_output",value:.95}},{label:"Guard clamp engaged",test:{type:"eventAtLeast",event:"CLAMP",n:1}},{label:"Violation latched",test:{type:"eventAtLeast",event:"VIOLATION LATCHED",n:1}},{label:"Violation cleared (BTN3)",test:{type:"eventAtLeast",event:"VIOLATION CLEARED",n:1}},{label:"Surge applied (BTN0)",test:{type:"anyTrue",field:"button_pressed"}},{label:"Safe limit moved (BTN1/BTN2)",test:{type:"eventAtLeast",event:["LIMIT UP","LIMIT DOWN"],n:1}}],disclaimers:["Volatile FPGA programming."],about:{heading:"About this guard — and how to drive it",lede:"Promise: the safe output never exceeds the safe limit or the demand.",sections:[{h:"Real life",body:"Motor / power / heater / actuator ceilings held below a safe maximum."},{h:"Use it",body:"A last-line interlock between a controller and a power stage."}],operate:{intro:"Operating the contract",rows:[["SW0–SW3","set the demand"],["BTN0","surge the demand over the limit"],["BTN1 / BTN2","raise / lower the safe limit"],["BTN3","acknowledge a latched violation"]]}}};function w(e){return e.map(t=>({schema_version:t.schema_version,sample_index:t.sample_index,timestamp_ms:t.timestamp_ms,switch_bits:t.switch_bits,source_mode:t.source_mode,board_id:"— (virtual)",kernel_id:t.kernel_sha256,button_pressed:t.button_pressed,requested_output:t.guard.requested_output,safe_output:t.guard.safe_output,safe_limit:t.guard.limit,safety_margin:t.guard.safety_margin,violation_latched:t.guard.violation_latched,guard_action:t.guard.guard_action}))}function O(e){return{captured_at:e.toISOString(),device:"Browser FPGA simulator (Arty A7 model)",source:"virtual://arty001-switch-guard-sim",virtual:!0}}function G(e){return(e.skeleton??R).replace('"__FRAMES__"',()=>JSON.stringify(e.frames)).replace('"__CONFIG__"',()=>JSON.stringify(e.config)).replace('"__META__"',()=>JSON.stringify(e.meta))}function j(e){const t=n=>"{"+Object.keys(n).sort().map(s=>JSON.stringify(s)+":"+JSON.stringify(n[s])).join(",")+"}";return e.map(t).join(`
`)+`
`}async function z(e){const t=await crypto.subtle.digest("SHA-256",new TextEncoder().encode(e));return Array.from(new Uint8Array(t)).map(n=>n.toString(16).padStart(2,"0")).join("")}async function _(e,t,n){const s=await z(j(e)),r={...O(n),trace_sha256:s};return G({frames:e,config:t,meta:r})}async function ee(e,t){const n={...y,disclaimers:[...y.disclaimers,"Browser simulation — candidate-only; no Arty A7 was programmed or observed."]};return _(w(e),n,t)}const x={courseTitle:"Reflex Lab 01 — ESP32 Guard Virtual Replay",contractRule:"safe_output never exceeds the requested_output (the guard only reduces)",fields:{demandLabel:"pot_raw",requested:"requested_output",safe:"safe_output",limit:null,margin:"safety_margin",violation:null,guardAction:"guard_action",clampValue:"clamp_to_safe_output",button:"button_pressed"},contractCeilings:["requested_output"],trackLimitMoves:!1,traces:[{key:"pot_raw",label:"pot",color:"#7bdcff",width:2},{key:"requested_output",label:"request",color:"#ffb86b",width:2},{key:"safe_output",label:"safe",color:"#83e6ac",width:4}],provenance:[{key:"board_id",label:"Board"},{key:"kernel_id",label:"Kernel"},{key:"schema_version",label:"Schema"},{key:"source_mode",label:"Source"}],liveSourceValue:"live_board",deviceSignals:[{key:"led",label:"LED",onAt:.03},{key:"buzzer",label:"Buzzer",onAt:.03}],rubric:[{label:"Input swept toward full",test:{type:"maxAtLeast",field:"pot_raw",value:.85}},{label:"Guard clamp engaged",test:{type:"eventAtLeast",event:"CLAMP",n:1}},{label:"LED driven",test:{type:"maxAtLeast",field:"led",value:.5}},{label:"Buzzer activated",test:{type:"maxAtLeast",field:"buzzer",value:.5}},{label:"Mute button used",test:{type:"anyTrue",field:"button_pressed"}}],disclaimers:["Low-voltage educational evidence only."],about:{heading:"About this guard — and how to drive it",lede:"Firmware promise: output never exceeds the request; the guard only reduces.",sections:[{h:"Real life",body:"A dimmer / motor / setpoint capped before the load."}],operate:{intro:"Operating the contract",rows:[["Potentiometer","set the demand"],["Button","mute the buzzer"]]}}};function S(e){return e.map(t=>({schema_version:t.schema_version,sample_index:t.sample_index,timestamp_ms:t.timestamp_ms,pot_raw:t.pot_raw,source_mode:"browser_sim",board_id:"— (virtual)",kernel_id:t.kernel_id,button_pressed:t.button_pressed??!1,requested_output:t.outputs.requested_output,safe_output:t.outputs.safe_output,led:t.outputs.led,buzzer:t.outputs.buzzer,safety_margin:t.guard.safety_margin,guard_action:t.guard.guard_action}))}async function te(e,t){const n={...x,disclaimers:[...x.disclaimers,"Browser simulation — candidate-only; low-voltage educational evidence, not a hardware capture."]};return _(S(e),n,t)}function ae(e){return e.toISOString().replace("T","_").replace(/[:.]/g,"-").slice(0,19)}const p=600,f=180,b=26,g=f+b,d=14,P=80,k=90,H={lines:[{key:"safe_limit",color:"#ffd166",width:2,dashed:!0},{key:"safety_margin",color:"#c4b5fd",width:2,dashed:!1},{key:"requested_output",color:"#f7b267",width:2,dashed:!1},{key:"safe_output",color:"#8ee0b2",width:4,dashed:!1}],legend:[{label:"request",color:"#f7b267",dashed:!1,width:2},{label:"safe",color:"#8ee0b2",dashed:!1,width:3},{label:"limit",color:"#ffd166",dashed:!0,width:2},{label:"margin",color:"#c4b5fd",dashed:!1,width:2}]},$={lines:[{key:"pot_raw",color:"#7bdcff",width:2,dashed:!1},{key:"requested_output",color:"#ffb86b",width:2,dashed:!1},{key:"safe_output",color:"#83e6ac",width:4,dashed:!1},{key:"buzzer",color:"#a893ff",width:2,dashed:!1},{key:"button_pressed",color:"#ff9d9d",width:2,dashed:!0}],legend:[{label:"pot",color:"#7bdcff",dashed:!1,width:2},{label:"request",color:"#ffb86b",dashed:!1,width:2},{label:"safe",color:"#83e6ac",dashed:!1,width:3},{label:"buzzer",color:"#a893ff",dashed:!1,width:2},{label:"btn",color:"#ff9d9d",dashed:!0,width:2}]};function q(e){return Math.max(0,Math.min(1,e))}function B(e){return e.guard_action==="clamp_to_safe_output"}function V(e,t,n,s){const r=Math.max(1,t.length-1),l=(p-d*2)/r;e.fillStyle="#00080c",e.fillRect(0,0,p,f),e.fillStyle="rgba(255,122,122,0.16)";for(let o=0;o<=n;o++)if(B(t[o])){const i=d+o/r*(p-d*2);e.fillRect(i-l/2,d,l+1,f-d*2)}e.strokeStyle="rgba(216,232,228,0.09)",e.lineWidth=1;for(let o=0;o<=4;o++){const i=d+o/4*(f-d*2);e.beginPath(),e.moveTo(d,i),e.lineTo(p-d,i),e.stroke()}for(const o of s.lines){e.beginPath(),e.setLineDash(o.dashed?[5,4]:[]);for(let i=0;i<=n;i++){const u=d+i/r*(p-d*2),m=f-d-q(Number(t[i][o.key])||0)*(f-d*2);i===0?e.moveTo(u,m):e.lineTo(u,m)}e.strokeStyle=o.color,e.lineWidth=o.width,e.lineCap="round",e.stroke()}e.setLineDash([]);const c=d+n/r*(p-d*2);e.strokeStyle="rgba(255,242,166,0.7)",e.lineWidth=1,e.beginPath(),e.moveTo(c,d-6),e.lineTo(c,f-d+6),e.stroke()}function D(e,t,n){const s=f;e.fillStyle="#0a1620",e.fillRect(0,s,p,b),e.strokeStyle="rgba(216,232,228,0.12)",e.lineWidth=1,e.beginPath(),e.moveTo(0,s+.5),e.lineTo(p,s+.5),e.stroke();const r=s+b/2;e.textBaseline="middle",e.font="600 11px ui-monospace, 'SFMono-Regular', Menlo, monospace",e.textAlign="left";let l=12;for(const i of n)e.strokeStyle=i.color,e.lineWidth=i.width,e.setLineDash(i.dashed?[4,3]:[]),e.beginPath(),e.moveTo(l,r),e.lineTo(l+16,r),e.stroke(),e.setLineDash([]),l+=21,e.fillStyle="#aebfbb",e.fillText(i.label,l,r),l+=e.measureText(i.label).width+14;let c=p-12;e.textAlign="right",e.font="800 10px ui-monospace, 'SFMono-Regular', Menlo, monospace",e.fillStyle="#ff9d9d",e.fillText("VIRTUAL",c,r),c-=e.measureText("VIRTUAL").width+9,e.font="600 11px ui-monospace, 'SFMono-Regular', Menlo, monospace",e.fillStyle="#7d918d";const o="monogatelectronics ·";e.fillText(o,c,r),c-=e.measureText(o).width+8,t&&e.drawImage(t,c-18,r-18/2,18,18)}async function K(){try{const e=new Image;return e.src="/electronics-lab/assets/monogatelogo.png",await e.decode(),e}catch{return null}}function W(e,t){if(e<=t)return Array.from({length:e},(r,l)=>l);const n=[],s=(e-1)/(t-1);for(let r=0;r<t;r++)n.push(Math.round(r*s));return n[n.length-1]=e-1,n}function U(e,t,n){const s=document.createElement("canvas");s.width=p,s.height=g;const r=s.getContext("2d",{willReadFrequently:!0});if(!r)throw new Error("2D canvas context unavailable");const l=T(),c=W(e.length,P);return c.forEach((o,i)=>{V(r,e,o,t),D(r,n,t.legend);const{data:u}=r.getImageData(0,0,p,g),m=L(u,256),E=I(u,m),F=i===c.length-1?k*8:k;l.writeFrame(E,p,g,{palette:m,delay:F})}),l.finish(),l.bytes()}async function A(e,t,n){if(e.length===0)return;const s=await K(),r=U(e,t,s),l=new Uint8Array(r.length);l.set(r);const c=new Blob([l],{type:"image/gif"}),o=URL.createObjectURL(c),i=document.createElement("a");i.href=o,i.download=n,i.click(),URL.revokeObjectURL(o)}function re(e,t){return A(w(e),H,t)}function ne(e,t){return A(S(e),$,t)}export{Q as P,Z as W,te as a,ee as b,ne as c,re as e,ae as r};
